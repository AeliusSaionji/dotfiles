...
https_prgs="/usr/X11R6/bin/netscape:XW /usr/bin/lynx:XT /usr/bin/surf:XW"
http_prgs="/usr/bin/lynx:XT /usr/X11R6/bin/netscape:XW /usr/bin/surf:XW"
mailto_prgs="/usr/bin/mutt:VT /usr/bin/elm:VT /usr/bin/pine:VT /usr/bin/mail:VT"
gopher_prgs="/usr/bin/lynx:XT /usr/bin/gopher:XT"
ftp_prgs="/usr/bin/lynx:XT /usr/bin/ncftp:XT /usr/bin/surf:XW"
