...
syn keyword pentadactylCommand loadplugins lpl gr[oup] ! run Clistk[eys] Clk
    ...
    \ delqm[arks] dels[tyle] deluseragent delua dia[log] dlc[lear] doautoa[ll]
    ...
    \ mkv[imruntime] mlistk[eys] mlk mm[ap] mno[remap] munm[ap] nlistk[eys] nlk
    ...
    \ sessiona[ppend] sessionadd sessionl[oad] sessions[ave] mkses[sion] se[t]
    ...
    \ bf[irst] time tlistk[eys] tlk tm[ap] tno[remap] toolbarh[ide] tbh[ide]
    \ toolbars[how] tbs[how] toolbart[oggle] tbt[oggle] tunm[ap] una[bbreviate]
    \ u[ndo] undoa[ll] unl[et] unm[ap] unpin[tab] useragent ua verb[ose]
...
syn keyword pentadactylOption activate act altwildmode awim autocomplete au
    ...
    \ scrollsteps scs scrolltime sct sessiondir sesdir sessionfile sesfile
    \ sessionoptions sesop shell sh shellcmdflag shcf showmode smd
    \ showstatuslinks ssli showtabline stal spelllang spl strictfocus sf
    \ suggestengines tabclose tc tabopen to timeoutlen tmol titlestring
    \ urlseparator urlsep us useragent ua verbose vbs wildanchor wia wildcase
    \ wic wildignore wig wildmode wim wildsort wis wordseparators wsp yankshort
    \ ys
