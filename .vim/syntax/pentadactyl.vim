...
syn keyword pentadactylCommand loadplugins lpl gr[oup] ! run Clistk[eys] Clk
    ...
    \ delqm[arks] dels[tyle] dia[log] doautoa[ll] do[autocmd] ec[ho] echoe[rr]
    \ echom[sg] el[se] elsei[f] elif em[enu] en[dif] fi exe[cute] exit x
    \ exta[dd] extde[lete] extrm extd[isable] exte[nable] exto[ptions]
    \ extp[references] extr[ehash] extt[oggle] extu[pdate] feedkeys fk fini[sh]
    \ fo[rward] fw frameo[nly] ha[rdcopy] h[elp] helpa[ll] hi[ghlight] hist[ory]
    \ hs ia[bbreviate] if ilistk[eys] ilk im[ap] ino[remap] iuna[bbreviate]
    ...
    \ messc[lear] mkp[entadactylrc] mkv[imruntime] mlistk[eys] mlk mm[ap]
    \ mno[remap] munm[ap] nlistk[eys] nlk nm[ap] nno[remap] noh[lfind] no[remap]
    \ norm[al] nunm[ap] olistk[eys] olk om[ap] ono[remap] o[pen] ounm[ap]
    \ pa[geinfo] pagest[yle] pas pin[tab] pref[erences] prefs pr[ivate] pr0n
    \ porn pw[d] qma[rk] qmarks q[uit] quita[ll] qa[ll] redr[aw] reg[isters]
    \ reh[ash] re[load] reloada[ll] res[tart] runt[ime] sa[nitize] sav[eas]
    \ w[rite] sbcl[ose] scrip[tnames] se[t] setg[lobal] setl[ocal] sideb[ar]
    \ sb[ar] sbop[en] sil[ent] so[urce] st[op] stopa[ll] sty[le] styled[isable]
    \ styd[isable] stylee[nable] stye[nable] stylet[oggle] styt[oggle] tab
    ...
    \ tm[ap] tno[remap] toolbarh[ide] tbh[ide] toolbars[how] tbs[how]
    \ toolbart[oggle] tbt[oggle] tunm[ap] una[bbreviate] u[ndo] undoa[ll]
    \ unl[et] unm[ap] unpin[tab] verb[ose] ve[rsion] vie[wsource] vlistk[eys]
    \ vlk vm[ap] vno[remap] vunm[ap] winc[lose] wc[lose] wind[ow] winon[ly]
...
syn keyword pentadactylAutoEvent BookmarkAdd BookmarkChange BookmarkRemove
    \ ColorScheme DOMLoad Fullscreen LocationChange PageLoadPre PageLoad
...
syn keyword pentadactylOption activate act altwildmode awim autocomplete au
    ...
    \ fileencoding fenc findcase fc findflags ff followhints fh guioptions go
    \ helpfile hf hintinputs hin hintkeys hk hintmatching hm hinttags ht
    \ hinttimeout hto history hi iskeyword isk jumptags jt linenumbers ln
    \ loadplugins lpl maxitems messages msgs newtab nextpattern pageinfo pa
    \ passkeys pk passunknown pu popups pps previouspattern runtimepath rtp
